<template>
  <div class="notice">
   ...
   <el-row>
  <el-button type="primary" size="small" @click="dialogVisible=true;forms.action='add'" icon="el-icon-circle-plus">新增</el-button>
...
<el-table
 ...
 <el-table-column
  ...
  <el-pagination
   ...
   <el-dialog :title="dialogTitle"  v-if='dialogVisible' :visible.sync="dialogVisible" :destroy-on-close="true" @open="openDialog">
...
<style lang="less" scoped>
  ...
  .search /deep/ .el-range-editor.el-input__inner{
     padding: 0 5px;
  }
