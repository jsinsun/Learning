...
<el-table
 ...
 <el-table-column
      ...
      width="150">
      <template slot-scope="scope">
        <el-button  type="text" size="small" @click.native="handleCreate(scope.row)">发起</el-button>
...
export default {
  ...
  methods: {
    ...
    handleCreate (row) {
      this.$router.push({ name: 'process', params: { Leave: '18:32a17123-98ee-11e9-84b3-1adc1de1bcbc' } })
    }
  }
}
</script>
